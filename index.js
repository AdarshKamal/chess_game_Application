...
function dragStart(e){
 ...
 function dragDrop(e){
    ...
    const taken = e.target.classList.contains('component')
 ...
 function checkIfValid(target){
    ...
    const component=draggedElement.id
    ...
    switch(component){
        case 'pawn':
            ...
            if(
                (row.includes(startId) && startId + width* 2 ===targetId)||
